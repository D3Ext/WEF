...
function report-gen(){
	...
	echo -e "[WEF] WiFi Exploitation Framework" > /opt/WEF/main/captures/$name/log.txt 2>/dev/null
	echo -e "---------------------------------" >> /opt/WEF/main/captures/$name/log.txt 2>/dev/null
	echo -e "Date of the attack: $actual_date" >> /opt/WEF/main/captures/$name/log.txt 2>/dev/null
	echo -e "Type of attack selected: $type_of_attack" >> /opt/WEF/main/captures/$name/log.txt 2>/dev/null
	echo -e "Attack completed against: $name" >> /opt/WEF/main/captures/$name/log.txt 2>/dev/null
	echo -e "Duration of the attack: $attack_time" >> /opt/WEF/main/captures/$name/log.txt 2>/dev/null
	echo -e "Channel of the AP: $channel" >> /opt/WEF/main/captures/$name/log.txt 2>/dev/null
	echo -e "---------------------------------" >> /opt/WEF/main/captures/$name/log.txt 2>/dev/null
}
