...
function helpPanel(){
	...
	echo -e "\n${blueColour}[${endColour}${yellowColour}WEF${endColour}${blueColour}] Wi-Fi Exploitation Framework${endColour} ${yellowColour}1.5.0${endColour}"
...
function report-gen(){
	...
	echo -e "\nType of attack selected: $type_of_attack" >> /opt/WEF/main/captures/$name/log.txt
...
function pkmid_attack(){
	...
	cp ${dir}/pkmid_hashes /opt/WEF/main/captures/$name/
